...
public class testDrawTest extends TestCase {
    ...
    public void testGreenButton(){
        cs.easel.DrawPanel.changeGreen();
        assertEquals(Color.GREEN, cs.easel.DrawPanel.currentColor);
    }

    public void testBlueButton(){
        cs.easel.DrawPanel.changeBlue();
        assertEquals(Color.BLUE, cs.easel.DrawPanel.currentColor);
    }
